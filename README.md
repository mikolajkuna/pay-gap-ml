...
- Estimation of counterfactual gender pay gaps
- SHAP-based feature explainability
- Clean, modular code for reproducible analysis

## Project Structure
- `src/` – preprocessing, feature engineering, model training, predictions  
- `data/` – raw, interim, and processed datasets  
- `notebooks/` – exploratory analysis and visualization  
- `models/` – saved trained models  
- `reports/figures/` – plots and visualizations of results
