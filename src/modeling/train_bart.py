...
class BartTrainer:
    """
    Trainer class for Bayesian Additive Regression Trees (BART) salary prediction.
    Handles loading, preprocessing, training, and evaluation.
    """
