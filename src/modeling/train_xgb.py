...
class XGBTrainer:
    """
    XGBoost trainer class for salary prediction.
    ...
    def train_model(self, n_estimators: int = 200, max_depth: int = 6, learning_rate: float = 0.1, random_state: int = 42) -> xgb.XGBRegressor:
