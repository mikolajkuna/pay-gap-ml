...
class BartPredictor:
    """
    Predictor class for Bayesian Additive Regression Trees (BART) salary prediction.
    Handles test data loading, preprocessing, prediction, and counterfactual gender pay gap analysis.
    """

    def __init__(self, model: BART, data_path: Path, feature_columns: List[str]) -> None:
        self.model = model
